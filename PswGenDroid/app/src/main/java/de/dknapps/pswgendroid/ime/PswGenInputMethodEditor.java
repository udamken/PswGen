 ...
 ************************************************************************************/
package de.dknapps.pswgendroid.ime;
...
import de.dknapps.pswgendroid.ui.ServiceDetailFragment;
...
public class PswGenInputMethodEditor extends InputMethodService implements KeyboardView.OnKeyboardActionListener {
    ...
    public void onKey(int primaryCode, int[] keyCodes) {
        ...
        switch (primaryCode) {
            case (int) '1':
                sendKeyEvents(ic, ServiceDetailFragment.Companion.getProvidedLoginInfo());
                break;
            case (int) '2':
                sendKeyEvents(ic, ServiceDetailFragment.Companion.getProvidedPassword());
                break;
            ...
            case Keyboard.KEYCODE_CANCEL:
                ServiceDetailFragment.Companion.resetProvidedLoginInformationPassword();
